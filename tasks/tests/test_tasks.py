...
class TaskAPITests(APITestCase):
    def setUp(self):
        ...
        token = self.client.post("/api/token/", {"username": "andrew", "password": "pass1234"}).data["access"]
    ...
    def test_create_and_list(self):
        ...
        r = self.client.post("/api/tasks/", {"title": "Do it", "priority": 2, "due_date": due}, format="json")
